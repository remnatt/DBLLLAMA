...
[JsonSerializable(typeof(SendDataResponse))]
...
public partial class LogJsonContext : JsonSerializerContext
{
    ...
    public class DBLLogger
    {
        ...
        public DBLLogger(string logFile = "dblpsLog.json")
        {
            ...
            {
                WriteIndented = true,
                TypeInfoResolver = LogJsonContext.Default
            };
        }
        ...
        public void LogEvent(string eventType, string message, object data = null, string level = "INFO")
        {
            ...
            if (data != null)
            {
                ...
                {
                    Console.WriteLine($"    Data: [Serialization failed: {ex.Message}]");
                }
            }
        }
    ...
    public class PersistentClient
    {
        ...
        public PersistentClient()
        {
            ...
            _logger.LogEvent("CLIENT_INIT", "DBL Client initialized", new Dictionary<string, object>
            {
                ["apihost"] = ApiHost,
                ["apiport"] = ApiPort,
        ...
        private (string host, int port) GetHttpProxy()
        {
            try
            {
                ...
                {
                    _logger.LogEvent("PROXY_CHECK", "Checked for HTTP proxy", new Dictionary<string, object>
                    {
                        ["proxy_found"] = true,
                        ["proxy_host"] = parts[0],
                        ["proxy_port"] = port
        ...
        private async Task ListenForDataAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                while (!cancellationToken.IsCancellationRequested && _isConnected)
                {
                    ...
                    _logger.LogNetworkActivity("PACKET_RECEIVED", new Dictionary<string, object>
                    {
            ...
            {
                _logger.LogEvent("LISTEN_ERROR", $"Error in listening task: {e.Message}", new Dictionary<string, object> { ["error"] = e.Message }, "ERROR");
            }
            finally
            {
        ...
        public async Task SendDataAsync(byte[] data)
        {
            ...
            try
            {
                ...
                _logger.LogNetworkActivity("PACKET_SENT", new Dictionary<string, object>
                {
            ...
            {
                _logger.LogEvent("SEND_ERROR", $"Failed to send data: {e.Message}", new Dictionary<string, object> { ["error"] = e.Message }, "ERROR");
            }
        }
        ...
        public async Task DisconnectAsync()
        {
            ...
            {
                _logger.LogEvent("DISCONNECT_ERROR", $"Error during disconnect: {e.Message}", new Dictionary<string, object> { ["error"] = e.Message }, "ERROR");
            }
            finally
            {
                _logger.SaveLog();
...
public class ApiController
{
    ...
    public async Task<IResult> SendData(HttpRequest request)
    {
        ...
        try
        {
            ...
            return Results.Ok(new SendDataResponse 
            { 
    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            {
                options.SerializerOptions.TypeInfoResolver = LogJsonContext.Default;
            });
